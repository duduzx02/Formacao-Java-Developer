package ClaroJavaComSpringBoot.CalculandoConsumoELimiteDeDadosMoveis;
...
public class CalculoDeConsumoDeDadosMoveis {
    ...
    public static int calcularConsumoTotal(String[] consumoSemanal) {
        return  Arrays.stream(consumoSemanal)
                .map(String::trim) // Removendo os espacos em branco
                .mapToInt(Integer::parseInt) // Convertendo para inteiro
                .sum(); // Somando os valores
    }
    ...
    public static int calcularMediaSemanal(int totalConsumo, int numeroDeSemanas) {
        ...
        // TODO: Calcule a média semanal de consumo de dados móveis
