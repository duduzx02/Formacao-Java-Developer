package ClaroJavaComSpringBoot.CalculandoConsumoeDescontoDeTelefonia;
...
public class CalculadoraCredito {
    ...
    public static void main(String[] args) {
        ...
        while (scanner.hasNextLine()) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                double valortotal = calcularCustoLigacao(duracao, valorPorMinuto);
    ...
    static double calcularCustoLigacao(int duracao, double valorPorMinuto) {
